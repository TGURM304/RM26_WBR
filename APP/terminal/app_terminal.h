...
#define TERMINAL_SEND(val, sz) bsp_uart_send_async(TERMINAL_PORT, (uint8_t *)val, sz)
#define TERMINAL_INFO(str, args...) bsp_uart_printf_async(TERMINAL_PORT, str, ##args)
#define TERMINAL_ERROR(str, args...) bsp_uart_printf_async(TERMINAL_PORT, TERMINAL_COLOR_RED str, ##args)
#define TERMINAL_ERROR_BLOD(str, args...) bsp_uart_printf_async(TERMINAL_PORT, ANSI_BOLD_ON TERMINAL_COLOR_RED str ANSI_BOLD_OFF, ##args)
