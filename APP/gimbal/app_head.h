...
public:
    ...
    void head_init(const Controller::PID& yaw_speed_param,const Controller::PID& yaw_pos_param,
        const Controller::PID& pit_speed_param, const Controller::PID& pit_pos_param
...
private:
    ...
    Controller::PID pit_speed_, pit_pos_, yaw_speed_, yaw_pos_, yaw_current_;
    uint16_t head_flag_{};
