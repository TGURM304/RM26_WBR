...
Motor::DJIMotor yaw_motor("yaw_motor",Motor::DJIMotor::GM6020,
    {.id = 0x01, .port = E_CAN3, .mode = Motor::DJIMotor::VOLTAGE});
...
Controller::PID yaw_pos(0,0,0,0,0);
Controller::PID yaw_speed(0,0,0,0,0);
Controller::PID yaw_current(0,0,0,0,0);
