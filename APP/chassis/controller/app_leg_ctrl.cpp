...
void Controller::app_leg_ctrl::left_len_update(Relay::leg_status left_leg, float target_len) {
...
void Controller::app_leg_ctrl::right_len_update(Relay::leg_status right_leg, float target_len) {
...
void Controller::app_leg_ctrl::left_deg_update(Relay::leg_status left_leg, float target_deg) {
...
void Controller::app_leg_ctrl::right_deg_update(Relay::leg_status right_leg, float target_deg) {
