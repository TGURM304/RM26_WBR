...
class Matrixf {
 public:
  ...
  void vector_cross_multiple(const Matrixf<3, 1>& mat1,const Matrixf<3, 1>& mat2) {
    ...
    this->data_[0] = mat1.data_[1]*mat2.data_[2] - mat1.data_[2]*mat2.data_[1];
    this->data_[1] = mat1.data_[2]*mat2.data_[0] - mat1.data_[0]*mat2.data_[2];
    this->data_[2] = mat1.data_[0]*mat2.data_[1] - mat1.data_[1]*mat2.data_[0];
